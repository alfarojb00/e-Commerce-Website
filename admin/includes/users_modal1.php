...
<!-- Open Photo -->
<div class="modal fade" id="open_id">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
              <?php
                ...
                $image = '../images/VALID_IDS/'.$r['dist_id'];
              ?>
...
<!-- Open App Form -->
<div class="modal fade" id="open_apform">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
              <?php
                ...
                $file = '../images/APPLICATION_FORMS/'.$r['application_form'];
              ?>
              <embed src="<?php echo $file; ?>" width="100%" height="1000px" />
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default pull-right" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
            </div>
